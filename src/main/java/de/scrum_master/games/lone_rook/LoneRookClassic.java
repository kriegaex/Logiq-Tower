 ...
 * "Cogito"-Monatsr�tsel - Mai 2004<br>
 * Der einsame Turm
 * <p>
 ...
 * vorher noch kurz Gertrud anrufen." Ich st�hnte innerlich auf, aber sagte
 * ergeben: "Ja." Wenn meine Frau mit ihrer Freundin telefoniert, dauert das
 * immer mindestens eine Stunde. Den Abwasch w�rde ich also alleine machen
 * m�ssen. Ich hatte gerade hei�es Wasser ins Sp�lbecken gelassen, als mir
 * einfiel, dass meine Tochter mir eigentlich helfen k�nnte. Christina, die im
 * Wohnzimmer sa�, erwiderte auf meine Bitte nur: "St�r mich nicht. Du siehst
 * doch, ich spiele Schach."
 * <p>
 * Vor meiner Tochter auf dem Tisch lag ein Schachbrett, auf dem nur ein
 * einzelner wei�er Turm stand. Sonst war keine Figur zu sehen. Konzentriert
 ...
 * Abwasch dr�cken. Viel verstehe ich ja nicht von Schach, aber soviel wei� ich
 ...
 * keinen Zweck, dir dieses Schachproblem zu erkl�ren. Du wirst es doch nicht
 * l�sen k�nnen. Aber wenn du darauf bestehst, werde ich es versuchen."
 * Beleidigt erwiderte ich: "Du untersch�tzt mich."
 * <p>
 * Christina verdrehte die Augen und sagte: "Also, pass auf. Der Turm steht auf
 * dem Feld d5 des Schachbretts. Er soll mit m�glichst wenigen Z�gen einmal �ber
 * alle Felder des Bretts gef�hrt werden und zum Schluss wieder zum Ausgangsfeld
 * zur�ckgelangen. Dabei darf der Turm kein Feld mehrmals betreten. Eine
 * Ausnahme ist nat�rlich das Startfeld, das ja gleichzeitig das Zielfeld ist,
 * und darum insgesamt zweimal betreten werden muss. Der Turm darf
 * selbstverst�ndlich nur die beim Schach �blichen Z�ge machen. Ein Feld gilt
 * auch dann als betreten, wenn der Turm bei einem Zug nur �ber dieses Feld
 * l�uft. Zieht also beispielsweise der Turm von a1 nach a4, so hat er dabei
 * auch die Felder a2 und a3 betreten. Wie viele Z�ge sind mindestens f�r diese
 * Rundtour notwendig?"
 * <p>
 * "Das kann doch nicht so schwer sein", dachte ich und probierte einige Minuten
 * mit dem Turm herum. Mein bestes Ergebnis waren 22 Z�ge. Christina l�chelte
 * �berlegen und meinte, sie h�tte doch Recht gehabt, ich sei mit dem Problem
 * �berfordert.
 * <p>
 * Wissen Sie, was die kleinste Anzahl von Z�gen ist, mit der der Turm seinen
